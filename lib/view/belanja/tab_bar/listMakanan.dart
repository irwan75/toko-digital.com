...
class ListMakanan extends StatefulWidget {
  ...
  ListMakanan({this.makanan, this.makananSub});

  @override
  _ListMakananState createState() =>
      _ListMakananState(makanan: makanan, makananSub: makananSub);
}

class _ListMakananState extends State<ListMakanan> {
  final List<Data_barang> makanan;
  final List<String> makananSub;
  _ListMakananState({this.makanan, this.makananSub});
  @override
