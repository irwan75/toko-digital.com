...
class ListProdukOlahan extends StatefulWidget {
  final List<Data_barang> produkOlahan;
  final List<String> produkOlahanSub;
  ListProdukOlahan({this.produkOlahan, this.produkOlahanSub});

  @override
  _ListProdukOlahanState createState() => _ListProdukOlahanState(
      produkOlahan: produkOlahan, produkOlahanSub: produkOlahanSub);
}

class _ListProdukOlahanState extends State<ListProdukOlahan> {
  final List<Data_barang> produkOlahan;
  final List<String> produkOlahanSub;
  _ListProdukOlahanState({this.produkOlahan, this.produkOlahanSub});
