...
class ListMinuman extends StatefulWidget {
  ...
  ListMinuman({this.minuman, this.minumanSub});

  @override
  _ListMinumanState createState() =>
      _ListMinumanState(minuman: minuman, minumanSub: minumanSub);
}

class _ListMinumanState extends State<ListMinuman> {
  final List<Data_barang> minuman;
  final List<String> minumanSub;
  _ListMinumanState({this.minuman, this.minumanSub});
  @override
