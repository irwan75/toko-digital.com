...
class ListPerawatanTubuh extends StatefulWidget {
  final List<Data_barang> perawatanTubuh;
  final List<String> perawatanTubuhSub;
  ListPerawatanTubuh({this.perawatanTubuh, this.perawatanTubuhSub});

  @override
  _ListPerawatanTubuhState createState() => _ListPerawatanTubuhState(
      perawatanTubuh: perawatanTubuh, perawatanTubuhSub: perawatanTubuhSub);
}

class _ListPerawatanTubuhState extends State<ListPerawatanTubuh> {
  final List<Data_barang> perawatanTubuh;
  final List<String> perawatanTubuhSub;
  _ListPerawatanTubuhState({this.perawatanTubuh, this.perawatanTubuhSub});
  @override
          ...
          children: <Widget>[
            Column(
                children: List.generate(
                    widget.perawatanTubuhSub.length > 1
                        ? widget.perawatanTubuhSub.length - 1
                        : 0, (index) {
              return Container(
                width: MediaQuery.of(context).size.width,
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Text(
                        widget.perawatanTubuhSub[index],
                    ...
                    Wrap(
                      children: createItemss(widget.perawatanTubuhSub[index],
                          widget.perawatanTubuh),
                    )
                  ],
                ),
              );
