...
class ListIbudanAnak extends StatefulWidget {
  final List<Data_barang> ibudanAnak;
  final List<String> ibudanAnakSub;
  ListIbudanAnak({this.ibudanAnak, this.ibudanAnakSub});

  @override
  _ListIbudanAnakState createState() => _ListIbudanAnakState(
      ibudanAnak: ibudanAnak, ibudanAnakSub: ibudanAnakSub);
}

class _ListIbudanAnakState extends State<ListIbudanAnak> {
  final List<Data_barang> ibudanAnak;
  final List<String> ibudanAnakSub;
  _ListIbudanAnakState({this.ibudanAnak, this.ibudanAnakSub});
  @override
                  ...
                  children: <Widget>[
                    ...
                    Wrap(
                      children: createItemss(
                          widget.ibudanAnakSub[index], widget.ibudanAnak),
                    )
                  ],
                ),
              );
