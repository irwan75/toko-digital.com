...
class ListRumahTangga extends StatefulWidget {
  final List<Data_barang> rumahTangga;
  final List<String> rumahTanggaSub;
  ListRumahTangga({this.rumahTangga, this.rumahTanggaSub});

  @override
  _ListRumahTanggaState createState() => _ListRumahTanggaState(
      rumahTangga: rumahTangga, rumahTanggaSub: rumahTanggaSub);
}

class _ListRumahTanggaState extends State<ListRumahTangga> {
  final List<Data_barang> rumahTangga;
  final List<String> rumahTanggaSub;
  _ListRumahTanggaState({this.rumahTangga, this.rumahTanggaSub});
  @override
