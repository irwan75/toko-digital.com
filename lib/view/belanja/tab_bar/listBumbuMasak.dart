...
class ListBumbuMasak extends StatefulWidget {
  final List<Data_barang> bumbuMasak;
  final List<String> bumbuMasakSub;
  ListBumbuMasak({this.bumbuMasak, this.bumbuMasakSub});

  @override
  _ListBumbuMasakState createState() => _ListBumbuMasakState(
      bumbuMasak: bumbuMasak, bumbuMasakSub: bumbuMasakSub);
}

class _ListBumbuMasakState extends State<ListBumbuMasak> {
  final List<Data_barang> bumbuMasak;
  final List<String> bumbuMasakSub;
  _ListBumbuMasakState({this.bumbuMasak, this.bumbuMasakSub});
  @override
