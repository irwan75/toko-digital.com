...
class ListKesehatan extends StatefulWidget {
  final List<Data_barang> kesehatan;
  final List<String> kesehatanSub;
  ListKesehatan({this.kesehatan, this.kesehatanSub});

  @override
  _ListKesehatanState createState() =>
      _ListKesehatanState(kesehatan: kesehatan, kesehatanSub: kesehatanSub);
}

class _ListKesehatanState extends State<ListKesehatan> {
  final List<Data_barang> kesehatan;
  final List<String> kesehatanSub;
  _ListKesehatanState({this.kesehatan, this.kesehatanSub});
  @override
